...
RSpec.describe TodosController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #create' do
      expect(post: '/todos').not_to be_routable
    end

    it 'routes to #update via PUT' do
      expect(put: '/todos/1').not_to be_routable
    end

    it 'routes to #update via PATCH' do
      expect(patch: '/todos/1').not_to be_routable
    end

    it 'routes to #destroy' do
      expect(delete: '/todos/1').not_to be_routable
    end
  end
end
